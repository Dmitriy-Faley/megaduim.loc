...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/news2')) {
				$catalog[] = array(
					'name' => $this->language->get('text_news2'),
					'href' => $this->url->link('catalog/news2', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'catalog/news3')) {
				$catalog[] = array(
					'name' => $this->language->get('text_news3'),
					'href' => $this->url->link('catalog/news3', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/generalbanner')) {
				$catalog[] = array(
					'name' => $this->language->get('text_generalbanner'),
					'href' => $this->url->link('catalog/generalbanner', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			if ($this->user->hasPermission('access', 'catalog/doc')) {
				$catalog[] = array(
					'name' => $this->language->get('text_doc'),
					'href' => $this->url->link('catalog/doc', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/promo')) {
				$catalog[] = array(
					...
					'href' => $this->url->link('catalog/promo', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
