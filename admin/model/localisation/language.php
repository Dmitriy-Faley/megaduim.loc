...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {
		...
		foreach ($query->rows as $banner_image) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "banner_image SET banner_id = '" . (int)$banner_image['banner_id'] . "', language_id = '" . (int)$language_id . "', title = '" . $this->db->escape($banner_image['title']) . "', link = '" . $this->db->escape($banner_image['link']) . "', link_mob = '" . $this->db->escape($banner_image['link_mob']) . "', image = '" . $this->db->escape($banner_image['image']) . "', btn_link = '" . $banner_image['btn_link'] . "', sort_order = '" . (int)$banner_image['sort_order'] . "'");
		}
